    ...
    <section className="container-page my-6">
      <div className="flex flex-col md:flex-row justify-between md:items-center items-start md:gap-6 gap-0 md:max-w-none max-w-lg mx-auto">
        <article className="flex-[45%] lg:w-full w-auto text-secondary-color lg:py-8 py-3">
          <h1 className="text-secondary-color text-[2.6rem] leading-[1.1] font-bold" style={{fontFamily: "Nunito Sans SemiBold"}}>
            Estamos a un mensaje de{" "}
            <span className="md:block inline">distancia para asesorarlo en su</span>{" "}
            próximo proyecto
          </h1>
        ...
        <article className="flex-1  mt-5">
          ...
          <div>
            <h5
              className="text-secondary-color font-bold mt-5 mb-2"
      ...
      <div className="text-center mb-14">
        <button type="submit" className="button-red-primary-outline">Conoce más</button>
      </div>
    </section>
  );
};
