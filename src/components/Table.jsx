  ...
  return (
    <div className="mt-2 overflow-x-auto">
      ...
      {queries?.pageName && queries?.sectionName && queries?.accordionName ? (
        <p className="capitalize mt-2 font-bold text-white text-center bg-red-400 px-3.5 py-1.5 rounded-sm">{`${queries?.pageName} > ${queries?.sectionName} > ${queries?.accordionName}`}</p>
      ) : null}
